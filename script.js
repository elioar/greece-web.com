$(document).ready(function () {
    ...
    const $slider = $('.slider');
    const $nav = $('.nav');
    const animSpd = 750; // Consider moving this to CSS as recommended
    const distOfLetGo = $(window).width() * 0.2;
    let curSlide = 1;
    let animation = false;
    ...
    // Generating slides
    let arrCities = ['Athens', 'Thessaloniki', 'Mykonos', 'Zankithos', 'Santorini']; // Change number of slides in CSS also
